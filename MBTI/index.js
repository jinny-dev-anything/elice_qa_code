const questions = [
  ...
  {
    id: 4,
    text: "당신은 현실적인 정보보다 가능성이나 아이디어에 더 관심이 많나요?",
    yes: "N",
    no: "S",
  },
  {
    id: 5,
    text: "당신은 새로운 경험을 추구하는 편인가요?",
    yes: "N",
    no: "S",
  },
  {
    id: 6,
    text: "당신은 쉽게 스트레스를 받는 편인가요?",
    yes: "N",
    no: "S",
  },
  {
  ...
  {
    id: 11,
    text: "당신은 마감일이 있어야 더 집중이 잘 되나요?",
    yes: "J",
    no: "P",
  },
  {
    id: 12,
    text: "당신은 즉흥적인 결정보다 미리 준비하는 것을 선호하나요?",
    yes: "J",
    no: "P",
  },
];
